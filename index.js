 ...
 */
const SwaggerInputValidator = function (swagger, options) {
        ...
        if (swagger.paths) {
            ...
            if (options && typeof options !== 'object') {
                ...
                if (options) {
                    ...
                    let allowNull = options.allowNull;
 ...
 */
const getPathParametersFromUrl = function (url, parsingParameters) {
    const pathParameters = {};
    for (let variable of parsingParameters.variables) {
 ...
 */
const getErrors = function (swaggerParameters, queryParameters, pathParameters, bodyParameters) {
    const thisReference = this;
    ...
    if (this._strict) {
        var isPresentWithinTheSwagger = function (whereToSearch, variableName) {
            for (let parameter of swaggerParameters) {
 ...
 */
const getRequiredParameters = function (verb, url) {
 ...
 */
const getGeneriqueMiddleware = function (swaggerParameters) {
